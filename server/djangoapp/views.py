...
def get_dealer_details(request, dealer_id):
    context={}
    url = "https://e87ba2dc.us-south.apigw.appdomain.cloud/api/review"
...
def add_review(request, dealer_id):
    ...
    if request.method == 'GET':
        ...
        if (request.user.is_authenticated):
            ...
            print("add review", review)
            print("add review dealer id", dealer_id)
            new_payload = {}
            new_payload["review"] = review
            print("new Payload", new_payload)
            json_result = post_request("https://e87ba2dc.us-south.apigw.appdomain.cloud/api/review", new_payload, dealerID=dealer_id)
            print("post result", json_result)
